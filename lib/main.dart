...
import 'package:invoice_maker_app/data.dart';
...
class _detailState extends State<detail> {
  ...
  void initState() {
    ...
    super.initState();
    //get();
    perqnty = List.filled(demo.prod_name.length, "0");
    check = List.filled(demo.prod_name.length, false);
                  ...
                  child: ListTile(
                    ...
                    trailing: Checkbox(
                      ...
                      onChanged: (value) {
                        ...
                        print(check);
                        if(check[index]==true){
                          product.add("${demo.prod_name[index]}");
                          pric.add("${demo.price[index]}");
                          ...
                          product.remove(demo.prod_name[index]);
